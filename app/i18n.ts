export const translations = {
  mn: {
    nav: {
      services: "Үйлчилгээ",
      work: "Хийсэн ажил",
      process: "Хамтран ажиллах",
      about: "Миний тухай",
      cta: "Төсөл ярилцах",
    },
    hero: {
      available: "Шинэ төсөл хүлээн авч байна",
      title: "Бизнест тань ажиллах программыг санаанаас нь ашиглалт хүртэл бүтээнэ.",
      lead: "Би Баясгалан. Утсаар монголоор хариулдаг AI оператор, вэб сайт, захиалга болон санхүүгийн системийг бие даан хийдэг хөгжүүлэгч. Японд мэргэжил эзэмшээд, одоо Улаанбаатарт бодит бизнесүүдэд систем нэвтрүүлж байна.",
      primary: "Төслөө ярилцах",
      secondary: "Хийсэн ажлуудыг үзэх",
    },
    call: {
      label: "Жишээ дуудлага: Bedel AI Box кафены ширээний захиалга авч байна.",
      business: "Нарлаг кафе",
      status: "AI хариулж байна",
      ended: "Дуудлага дууссан",
      replay: "Дахин тоглуулах",
      doneTitle: "Захиалга системд бүртгэгдлээ",
      doneDetail: "Маргааш 12:00, 4 хүн, Болд. Сануулга SMS-ээр илгээгдсэн.",
      translations: [] as string[],
    },
    services: {
      title: "Юу хийж өгөх вэ",
      intro: "Та асуудлаа хэлээрэй. Би тохирох шийдлийг санал болгоод, бүтээж, ажиллуулж өгнө.",
      fitLabel: "Хэнд тохиромжтой вэ",
      exampleLabel: "Жишээ ажил",
      items: [
        {
          title: "AI утасны оператор",
          desc: "Дуудлагад өдөр шөнөгүй монголоор хариулж, захиалга болон цаг авч, QPay нэхэмжлэх илгээнэ. Ажилтнууд тань утсанд хүлээж суухгүй, нэг ч дуудлага алдагдахгүй.",
          fit: "Ресторан, эмнэлэг, салон, дэлгүүр",
          examples: ["bedel"],
        },
        {
          title: "Вэб сайт ба вэб апп",
          desc: "Цаг захиалгын систем, онлайн дэлгүүр, админ самбар гэх мэт. Утсан дээр ч, компьютер дээр ч хурдан ажиллаж, олон хэлийг дэмжинэ.",
          fit: "Үйлчилгээ, худалдаа, стартап",
          examples: ["booking", "ecommerce", "haiguul"],
        },
        {
          title: "Санхүү, бараа материалын систем",
          desc: "Борлуулалт, зардал, үлдэгдэл, НӨАТ болон eBarimt-ийг нэг дор бүртгэж, ашиг алдагдлаа бодит цагаар харна.",
          fit: "Жижиг, дунд бизнес",
          examples: ["bedelerp"],
        },
        {
          title: "AI автоматжуулалт",
          desc: "Хурлын тэмдэглэл хөтлөх, баримт боловсруулах, хэрэглэгчийн асуултад хариулах гэх мэт давтагддаг ажлыг AI-аар гүйцэтгүүлнэ.",
          fit: "Байгууллага, албан газар",
          examples: ["protocol", "mindsync"],
        },
      ],
    },
    work: {
      title: "Хийсэн ажлууд",
      intro: "Бодит хэрэглэгчтэй бүтээгдэхүүнээс эхлээд туршилтын төсөл хүртэл.",
      problemLabel: "Асуудал",
      solutionLabel: "Шийдэл",
      roleLabel: "Миний хийсэн зүйл",
      problem: "Жижиг бизнесүүд ачаалалтай цагаар болон ажлын бус цагаар утсаа авч чадалгүй, захиалгаа алддаг.",
      solution: "Утасны шугамд шууд холбогдож, монголоор ярилцан захиалга авч, төлбөрийн нэхэмжлэх илгээдэг AI оператор. Харилцагч бүр AI-ийн заавар болон бараа бүтээгдэхүүнээ өөрөө удирдана.",
      role: "Архитектур, backend, дуу хоолой боловсруулалт, админ самбар, сервер болон deploy. Бүгдийг нь ганцаараа хийсэн.",
      visit: "bedel.mn сайтад зочлох",
      othersTitle: "Бусад төслүүд",
    },
    process: {
      title: "Хэрхэн хамтран ажиллах вэ",
      steps: [
        {
          title: "Ярилцлага",
          desc: "Бизнес болон шийдэх гэж буй асуудлыг тань сонсоно. Юу хийвэл хамгийн их үр өгөхийг хамтдаа тодорхойлно.",
        },
        {
          title: "Санал",
          desc: "Хийх ажил, хугацаа, үнийг бичгээр тодорхой гаргаж өгнө. Та зөвшөөрсний дараа ажил эхэлнэ.",
        },
        {
          title: "Бүтээлт",
          desc: "Долоо хоног бүр ажиллаж буй хувилбарыг үзүүлж, санал хүсэлтийг тань тухай бүрт нь тусгана.",
        },
        {
          title: "Нээлт ба дэмжлэг",
          desc: "Системийг ашиглалтад оруулж, ажилтнуудад тань зааж өгнө. Нээсний дараа ч алдаа засаж, хөгжүүлэлтийг үргэлжлүүлнэ.",
        },
      ],
    },
    about: {
      title: "Яагаад надтай ажиллах вэ",
      points: [
        {
          title: "Эхнээс нь дуустал нэг хүн",
          desc: "Дизайн, backend, AI, сервер гээд бүгдийг өөрөө хийдэг. Мэдээлэл дамжихдаа гээгдэхгүй, хариуцлага нэг дор байна.",
        },
        {
          title: "Бодит ашиглалтын туршлага",
          desc: "Bedel AI Box бодит харилцагчдын дуудлагад хариулж байна. Демо биш, өдөр тутмын ажилд хэрэглэгдэж буй систем.",
        },
        {
          title: "Монгол, англи, япон хэлээр",
          desc: "Гадаадын харилцагчтай ажиллах, баримт бичгийг англи, япон хэлээр бэлтгэхэд асуудалгүй.",
        },
        {
          title: "Японд суралцсан",
          desc: "IT Engineer & Full-Stack Developer мэргэжлийг Японд эзэмшсэн. Тэндхийн нягт нямбай ажлын соёлыг төсөл бүртээ баримталдаг.",
        },
      ],
      techTitle: "Ашигладаг технологи",
    },
    contact: {
  ...
  en: {
    ...
    hero: {
      ...
      title: "I build the software your business runs on, from first idea to launch.",
      lead: "I'm Bayasgalan, an independent developer in Ulaanbaatar. I build AI receptionists that answer calls in Mongolian, websites, and booking and accounting systems. I trained in Japan and now ship systems for real businesses.",
      primary: "Discuss your project",
      secondary: "See my work",
    },
    call: {
      label: "Sample call: Bedel AI Box taking a table booking for a café. The call is in Mongolian, with a translation under each line.",
      business: "Narlag Café",
      status: "AI is answering",
      ended: "Call ended",
      replay: "Replay",
      doneTitle: "Booking saved to the system",
      doneDetail: "Tomorrow 12:00, 4 people, Bold. SMS reminder sent.",
      translations: [
        "Hello, this is Narlag Café. How can I help?",
        "I'd like to book a table for four tomorrow at noon.",
        "A table for four is free tomorrow at 12:00. Whose name should I put it under?",
        "Under Bold.",
        "Thank you, Bold. Your booking is confirmed. We'll send you a reminder by text.",
      ] as string[],
    },
    services: {
      title: "What I can build for you",
      intro: "Tell me the problem. I'll propose a fitting solution, build it, and keep it running.",
      fitLabel: "Good fit for",
      exampleLabel: "Example work",
      items: [
        {
          title: "AI phone receptionist",
          desc: "Answers every call in Mongolian, day and night. It takes orders and appointments and sends QPay invoices, so your staff stop waiting by the phone and no call goes unanswered.",
          fit: "Restaurants, clinics, salons, shops",
          examples: ["bedel"],
        },
        {
          title: "Websites and web apps",
          desc: "Booking systems, online stores, admin dashboards and more. Fast on phones and desktops, with support for multiple languages.",
          fit: "Service businesses, retail, startups",
          examples: ["booking", "ecommerce", "haiguul"],
        },
        {
          title: "Accounting and inventory systems",
          desc: "Record sales, expenses, stock, VAT and eBarimt receipts in one place, and see your profit in real time.",
          fit: "Small and medium businesses",
          examples: ["bedelerp"],
        },
        {
          title: "AI automation",
          desc: "Hand repetitive work to AI: meeting minutes, document processing, answering customer questions.",
          fit: "Companies and public organizations",
          examples: ["protocol", "mindsync"],
        },
      ],
    },
    work: {
      title: "Work",
      intro: "From a product with paying customers to experiments that taught me something.",
      problemLabel: "Problem",
      solutionLabel: "Solution",
      roleLabel: "What I did",
      problem: "Small businesses miss calls at peak hours and after closing, and every missed call is a lost order.",
      solution: "An AI receptionist that connects directly to the phone line, talks with callers in Mongolian, takes orders and sends payment invoices. Each client manages the AI's instructions and product list themselves.",
      role: "Architecture, backend, speech processing, admin dashboard, servers and deployment. I built all of it alone.",
      visit: "Visit bedel.mn",
    ...
    process: {
      ...
      steps: [
        {
          title: "Conversation",
          desc: "I listen to how your business works and what you want to fix, and we agree on what will make the biggest difference.",
        },
        {
          title: "Proposal",
          desc: "You get the scope, timeline and price in writing. Work starts once you approve it.",
        },
        {
          title: "Build",
          desc: "Every week you see a working version, and your feedback goes straight into the next one.",
        },
        {
          title: "Launch and support",
          desc: "I put the system into use and train your team. After launch I keep fixing issues and improving it.",
        },
      ],
    },
    about: {
      ...
      points: [
        {
          ...
          desc: "Design, backend, AI and servers: I do all of it, so nothing gets lost in handoffs and you always know who's responsible.",
        },
        {
          title: "Real production experience",
          desc: "Bedel AI Box answers real customers' calls. It's not a demo; it's a system businesses rely on day to day.",
        },
        {
          title: "Mongolian, English and Japanese",
          desc: "Working with international teams, and writing documentation in English or Japanese, is no problem.",
        },
        {
          title: "Trained in Japan",
          desc: "I studied IT Engineering & Full-Stack Development in Japan, and I bring its careful, detail-first way of working to every project.",
        },
      ],
  ...
  jp: {
    ...
    hero: {
      available: "新規案件を受付中",
      title: "ビジネスを支えるソフトウェアを、構想から運用まで。",
      lead: "ウランバートルを拠点に活動する開発者のバヤスガランです。モンゴル語で電話に応答するAI受付、Webサイト、予約・会計システムを一人で開発しています。日本で専門課程を修了し、現在は実際のビジネスにシステムを導入しています。",
      primary: "プロジェクトを相談する",
      secondary: "制作実績を見る",
    },
    call: {
      label: "通話例: Bedel AI Boxがカフェの席予約を受け付けています。通話はモンゴル語で、各発言の下に日本語訳を表示しています。",
      business: "ナルラグ・カフェ",
      status: "AI応答中",
      ended: "通話終了",
      replay: "もう一度再生",
      doneTitle: "予約がシステムに登録されました",
      doneDetail: "明日12:00、4名、ボルド様。SMSでリマインダー送信済み。",
      translations: [
        "お電話ありがとうございます、ナルラグ・カフェです。ご用件をどうぞ。",
        "明日の12時に4名で予約したいのですが。",
        "明日12時、4名様のお席をご用意できます。お名前をお願いします。",
        "ボルドです。",
        "ボルド様、ありがとうございます。ご予約を承りました。SMSでリマインダーをお送りします。",
      ] as string[],
    },
    services: {
      title: "提供できること",
      intro: "課題をお聞かせください。最適な解決策を提案し、開発から運用まで対応します。",
      fitLabel: "おすすめの業種",
      exampleLabel: "制作例",
      items: [
        {
          title: "AI電話受付",
          desc: "24時間モンゴル語で電話に応答し、注文や予約を受け付け、QPayの請求書を送信します。スタッフが電話対応に縛られず、取りこぼしもなくなります。",
          fit: "飲食店、クリニック、サロン、小売店",
          examples: ["bedel"],
        },
        {
          title: "WebサイトとWebアプリ",
          desc: "予約システム、ECサイト、管理画面など。スマートフォンでもPCでも快適に動き、多言語にも対応します。",
          fit: "サービス業、小売、スタートアップ",
          examples: ["booking", "ecommerce", "haiguul"],
        },
        {
          title: "会計・在庫管理システム",
          desc: "売上、経費、在庫、付加価値税、eBarimtを一か所で記録し、利益をリアルタイムで把握できます。",
          fit: "中小企業",
          examples: ["bedelerp"],
        },
        {
          title: "AIによる業務自動化",
          desc: "議事録作成、書類処理、顧客からの問い合わせ対応など、繰り返しの業務をAIに任せられます。",
          fit: "企業、公的機関",
          examples: ["protocol", "mindsync"],
        },
      ],
    ...
    work: {
      title: "制作実績",
      intro: "有料顧客のいるプロダクトから、学びを得た実験的なプロジェクトまで。",
      problemLabel: "課題",
      solutionLabel: "解決策",
      roleLabel: "担当範囲",
      problem: "小規模店舗は混雑時や営業時間外に電話に出られず、注文を逃しています。",
      solution: "電話回線に直接接続し、モンゴル語で会話して注文を受け、決済用の請求書を送るAI受付。各顧客がAIへの指示や商品情報を自分で管理できます。",
      role: "設計、バックエンド、音声処理、管理画面、サーバー構築、デプロイまで、すべて一人で担当。",
      visit: "bedel.mnを見る",
      othersTitle: "その他のプロジェクト",
    },
    process: {
      title: "進め方",
      steps: [
        {
          title: "ヒアリング",
          desc: "事業内容と解決したい課題を伺い、最も効果の高い施策を一緒に決めます。",
        },
        {
          title: "ご提案",
          desc: "作業範囲、スケジュール、費用を書面で明確にお伝えします。ご承認後に着手します。",
        },
        {
          title: "開発",
          desc: "毎週動くバージョンをお見せし、いただいたご意見をすぐに反映します。",
        },
        {
          title: "リリースとサポート",
          desc: "システムを導入し、スタッフの方に使い方をお伝えします。リリース後も不具合対応と改善を続けます。",
        },
      ],
    },
    about: {
      ...
      points: [
        {
          title: "最初から最後まで一人で担当",
          desc: "デザイン、バックエンド、AI、サーバーまで自分で手がけるため、引き継ぎで情報が抜け落ちることがなく、責任の所在も明確です。",
        },
        {
          title: "本番運用の実績",
          desc: "Bedel AI Boxは実際の顧客からの電話に応答しています。デモではなく、日々の業務で使われているシステムです。",
        },
        {
          title: "モンゴル語・英語・日本語に対応",
          desc: "海外チームとの協業や、英語・日本語でのドキュメント作成も問題ありません。",
        },
        {
          title: "日本で学んだ技術者",
          desc: "日本でIT Engineer & Full-Stack Developerの専門課程を修了。丁寧で細部までこだわる仕事の進め方を、すべてのプロジェクトで大切にしています。",
        },
      ],
      techTitle: "使用技術",
    },
